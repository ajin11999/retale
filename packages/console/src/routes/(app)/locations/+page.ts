import { CachePolicy, load_LocationList } from "$houdini";
...
// created / changed locations immediately instead of a stale cached tree.
export const load: PageLoad = async (event) => {
  return await load_LocationList({ event, policy: CachePolicy.NetworkOnly });
};
